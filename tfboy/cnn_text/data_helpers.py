...
def load_data_and_labels(positive_data_file, negative_data_file):
    ...
    # data = open(positive_data_file, "rb").read()
    # print(chardet.detect(data))
    positive = open(positive_data_file, "rb").read().decode('Windows-1252')
    negative = open(negative_data_file, "rb").read().decode('Windows-1252')
